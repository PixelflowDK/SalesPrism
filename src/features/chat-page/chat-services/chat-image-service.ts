...
// Exported (was module-private) so `gdpr-erasure-service.ts` can delete a
// data subject's image blobs by the SAME container name used to write them
// — never duplicate this string, or the two can silently drift apart.
export const IMAGE_CONTAINER_NAME = "images";
